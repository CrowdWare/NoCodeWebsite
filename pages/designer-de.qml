...
Du kannst zum Beispiel jede Änderung, die Du im XML vornimmst, sofort in der Vorschau sehen.  
...
```"
            ...
            Column {
                ...
                Markdown {
                    text: "
Ansonsten ist der Rest einfaches XML (Extended Markup Language). 

Eine App ist in Seites (pages) eingeteilt. Der User kann später von Seite zu Seite navigieren.   
...
"
        ...
        Row {
            ...
            Column {
                ...
                Markdown {
                    text: "Am Anfang jeder Datei steht eine Kennungs aus der die Version und Kodierung hervor geht.  
```xml 
&lt;?xml version=&quot;1.0&quot; encoding=&quot;utf-8&quot;?&gt;
```

Jede Seite bekommt danach einen sogenanten Tag, um zu erkennen, was für ein Typ die Datei hat. 
Im Falle der Seite ist dies Page. Ein Tag fängt immer mit dem Zeichen &quot;&lt;&quot; an und endet mit &quot;/&gt;&quot;.
```xml
&lt;page backgroundColor=&quot;#0000ßß&quot; color=&quot;#ffffFF&quot; padding=&quot;8&quot;/&gt;
```
